...
/**
 * This class implements ICardAction and stores information about where ICells should move upon processing an IMove.
 *
 * @author Tyler Jang
 */
public class CardAction implements ICardAction {
    ...
    /**
     * Constructor for CardAction, taking in a List of Consumers representing the updates to be processed.
     *
