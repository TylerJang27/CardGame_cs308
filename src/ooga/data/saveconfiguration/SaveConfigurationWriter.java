...
/**
 * Class for writing save configuration information into an XML file. Saves the name of the game, the path to the rules, the current phase, the score, and Strings used to rebuild cells.
 *
 * @author Tyler Jang
 */
public class SaveConfigurationWriter implements Writer {
     ...
     */
    private static void appendNodeAndText(Document document, Element root, String tag, String textValue) {
