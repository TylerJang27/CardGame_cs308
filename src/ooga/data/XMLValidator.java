...
/**
 * Class for validating XML files against an XML Schema. This is used for increased validation before rules, styling, and layouts are parsed.
 * <p>
 * Explanation and setup taken from:
...
public class XMLValidator {
    ...
    public static boolean validateXMLSchema(String xsdPath, String xmlPath) {
        ...
        System.out.println("we validated it!");
        return true;
    }
