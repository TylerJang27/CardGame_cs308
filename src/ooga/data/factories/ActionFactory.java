...
public class ActionFactory implements Factory {
    ...
    /**
     * Builds and returns an IAction built for an IMasterRule from a rules XML. Requirements for rules XML can be found in doc/XML_Documentation.md.
     *
     ...
     */
    private static ICell extractDestinationBehavior(Element e, ICell moverCell, ICell donorCell, ICell recipientCell, Map<String, ICellGroup> cellGroupMap) {
