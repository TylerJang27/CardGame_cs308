...
/**
 * This CellGroupFactory implements Factory and constructs ICellGroups using the createCellGroups() method.
 * These ICellGroups contain their own ICells with their own names and ability to hold other cells, decks, and cards.
 *
...
public class CellGroupFactory implements Factory {
    ...
    /**
     * Builds and returns a singular ICellGroup implementation with its internal ICells.
     * If an ICell name inside of an ICellGroup already exists, it will not be recreated (names must be unique).
     *
