...
public class SaveConfiguration implements ISaveConfiguration {
    ...
    /**
     * The Constructor for SaveConfiguration. Takes in game name information, the path to the rules, the name of the current phase, the score, and a Map to build cell information.
     *
     ...
     */
    public SaveConfiguration(String gameName, String rulePath, String phaseName, Double score, Map<String, String> cellBuilder) {
        myGameName = gameName;
        myRulePath = rulePath;
