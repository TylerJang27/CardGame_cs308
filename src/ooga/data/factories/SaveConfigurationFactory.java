...
/**
 * This SaveConfigurationFactory implements Factory and constructs an ISaveConfiguration using the createSave() method.
 * This ISaveConfiguration is used to load a state from a previous game.
 *
 * @author Tyler Jang
 */
public class SaveConfigurationFactory implements Factory {
    ...
    private static Map<String, String> extractCellBuilder(Element e) {
        ...
        for (int k = 0; k < cellNodeList.getLength(); k++) {
            ...
            cellMap.put(cell.getNodeName(), cell.getTextContent());
        }
        return cellMap;
    }
}
