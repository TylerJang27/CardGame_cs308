...
/**
 * Tests the functionality of MasterRules with respect to their ability to validate different moves after construction.
 *
 * @author Tyler Jang
 */
class MasterRuleFactoryTest {
    ...
    /**
     * Example test for MasterRule Factory, testing a number of moves and their validity against basic rule sets.
     */
    @Test
    void testCreateMasterRules() {
        ...
        Map<String, ICell> cellMap1 = Map.of("a", cellA, "b", cellB, "c", cellC, "d", cell0H, "j", cell9S);
        ...
        Element root1 = XMLHelper.getRootAndCheck(new File(TEST_DIRECTORY + "rules_basic1.xml"), "rule", "invalid file");
        Node node1 = getRulesNode(root1);
        List<IMasterRule> masterRuleList1 = MasterRuleFactory.createMasterRules(node1, cellGroupMap1, cellMap1, "first");
        ...
        Element root2 = XMLHelper.getRootAndCheck(new File(TEST_DIRECTORY + "rules_basic2.xml"), "rule", "invalid file");
        Node node2 = getRulesNode(root2);
        List<IMasterRule> masterRuleList2 = MasterRuleFactory.createMasterRules(node2, cellGroupMap1, cellMap1, "first");
