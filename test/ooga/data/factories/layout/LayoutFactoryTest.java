...
class LayoutFactoryTest {
    ...
    void createLayout() {
        ...
        assertEquals(actual1.getCellLayout().get("cpu").getX(), expected1.getCellLayout().get("cpu").getX());
        assertEquals(actual1.getCellLayout().get("playerr").getX(), expected1.getCellLayout().get("playerr").getX());
        assertEquals(actual1.getCellLayout().get("center").getX(), expected1.getCellLayout().get("center").getX());
        assertEquals(actual1.getCellLayout().get("playerl").getX(), expected1.getCellLayout().get("playerl").getX());
        assertEquals(actual1.getCellLayout().get("playerc").getX(), expected1.getCellLayout().get("playerc").getX());
        assertEquals(actual1.getCellLayout().get("cpu").getY(), expected1.getCellLayout().get("cpu").getY());
        assertEquals(actual1.getCellLayout().get("playerr").getY(), expected1.getCellLayout().get("playerr").getY());
        assertEquals(actual1.getCellLayout().get("center").getY(), expected1.getCellLayout().get("center").getY());
        assertEquals(actual1.getCellLayout().get("playerl").getY(), expected1.getCellLayout().get("playerl").getY());
        assertEquals(actual1.getCellLayout().get("playerc").getY(), expected1.getCellLayout().get("playerc").getY());
