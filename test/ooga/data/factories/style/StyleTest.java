...
public class StyleTest {
    ...
    public void testStyleWriter() {
        Map<String, String> wordSettings1 = Map.of("language", "english", "cards", "card_path", "table", "CS308");
        Map<String, Integer> numberSettings1 = Map.of("difficulty", 3, "sound", 1, "dark", 0);
        IStyle expectedStyle1 = new StyleData(TEST_DIRECTORY + "style_written1.xml", wordSettings1, numberSettings1);

        Map<String, String> wordSettings4 = Map.of("language", "english", "cards", "", "table", "");
        Map<String, Integer> numberSettings4 = Map.of("difficulty", 0, "sound", 0, "dark", 0);
        IStyle expectedStyle4 = new StyleData(TEST_DIRECTORY + "style_written2.xml", wordSettings4, numberSettings4);
        IStyle actualStyle6 = StyleFactory.createStyle(new File(TEST_DIRECTORY + "style_happy4.xml"), TEST_DIRECTORY + "style_written3.xml");

        expectedStyle1.saveSettings();
        expectedStyle4.saveSettings();
        actualStyle6.saveSettings();

        IStyle writtenStyle1 = StyleFactory.createStyle(new File(TEST_DIRECTORY + "style_written1.xml"));
        IStyle writtenStyle2 = StyleFactory.createStyle(new File(TEST_DIRECTORY + "style_written2.xml"));
        IStyle writtenStyle3 = StyleFactory.createStyle(new File(TEST_DIRECTORY + "style_written3.xml"));
